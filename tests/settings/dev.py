# this is a violent copy-paste from settings/test.py in intent to have
# a minimal set of dependencies to make things work enough to hack on the project
# please contribute by removing stuff
